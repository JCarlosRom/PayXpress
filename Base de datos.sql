...
-- Volcando datos para la tabla pay_express.cliente: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla pay_express.producto: ~4 rows (aproximadamente)
...
BEGIN
	...
	Declare Temp cursor for select Producto, Total, Precio_unitario,Tipo_pago, Cantidad  from temporal_venta ;
	...
	fetch temp into Producto_procedure, Total_procedure, Precio_unitario_procedure,Tipo_pago_procedure, Cantidad_procedure;
	

	
	insert into venta (IdEmpleado,IdCliente,Producto,FechaVenta,SubTotal,Cantidad,IVA,Total,FormaDePago) 
	values(Empleado_procedure,Cliente_procedure,Producto_procedure,CURDATE(),Precio_unitario_procedure,Cantidad_procedure,16,Total_procedure,Tipo_pago_procedure );
	
	
	
	UNTIL done END REPEAT;
	
	delete from venta where IdVenta= LAST_INSERT_ID();
...
INSERT INTO `venta` (`IdVenta`, `IdEmpleado`, `IdCliente`, `Producto`, `FechaVenta`, `SubTotal`, `Cantidad`, `IVA`, `Total`, `FormaDePago`) VALUES
	(40, 0, 1, '85A', '2018-05-29 00:00:00', 320, 2, 16, 640, b'1'),
	(42, 0, 1, '85A', '2018-05-29 00:00:00', 320, 2, 16, 640, b'1'),
	(44, 0, 1, '85A', '2018-05-29 00:00:00', 320, 2, 16, 640, b'1'),
	(46, 0, 1, '85A', '2018-05-29 00:00:00', 320, 2, 16, 640, b'1');
