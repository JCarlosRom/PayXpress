...
INSERT INTO `producto` (`IdProducto`, `NombreProducto`, `Marca`, `Modelo`, `IdTipoProducto`, `PrecioUnitario`, `Existencia`, `Estatus`) VALUES
	...
	(2, 'TINTA EPSOPN', 'EPSON', '664', 3, 140, 6, b'1'),
	(3, 'MOUSE', 'LOGITECH', 'M75', 2, 130, 10, b'1'),
	(4, 'Liquido limpiador PC', 'CleanPC', 'CleanPC', 3, 50, 9, b'1');
...
BEGIN
	...
	insert into venta (IdVenta,IdEmpleado,IdCliente,Producto,FechaVenta,SubTotal,Cantidad,IVA,Total,FormaDePago) 
	values(bandera+1,Empleado_procedure,Cliente_procedure,Producto_procedure,CURDATE(),Precio_unitario_procedure,Cantidad_procedure,(Total_procedure*.16),Total_procedure,Tipo_pago_procedure );
...
-- Volcando datos para la tabla pay_express.venta: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `venta` DISABLE KEYS */;
INSERT INTO `venta` (`ID`, `IdVenta`, `IdEmpleado`, `IdCliente`, `Producto`, `FechaVenta`, `SubTotal`, `Cantidad`, `IVA`, `Total`, `FormaDePago`) VALUES
	(39, NULL, 0, 5, 'TINTA EPSOPN', '2018-05-29 00:00:00', 140, 1, 22.4, 140, b'1');
