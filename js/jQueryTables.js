...
function jQueryTableServices(id_container, headers, data, LimitRow, maxHeight, NameFunc) {
	...
	$('#thead_servicios').empty()
	$('#thead_servicios').append(thead)
	...
	$('#tbody_servicios').empty()
	$('#tbody_servicios').append(tbody)
